        ...
        <div x-data="{ open: false }" class="flex flex-col w-full px-8 py-2 mx-auto md:px-12 md:items-center md:justify-between md:flex-row lg:px-32 max-w-7xl">
            ...
            <div class="flex items-center md:ml-auto">
                <nav :class="{'flex': open, 'hidden': !open}" class="flex-col items-center flex-grow hidden gap-3 p-4 px-5 text-sm font-medium text-gray-500 md:p-0 md:flex md:flex-row">
                    <a class="hover:text-black focus:outline-none focus:text-gray-500 mr-4 mb-1" href="<?php echo e(route('login')); ?>">
                    Login
                    </a>
                    <a2 class="hover:text-black" href="<?php echo e(route('register')); ?>">
                        <a class="hover:text-black focus:outline-none focus:text-gray-500 mb-1" href="<?php echo e(route('register')); ?>">
                        Sign Up
                        </a>
                    </a2>
                </nav>
            ...
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/kairi.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
          <li class="p-2 border bg-gray-50 rounded-3xl">
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/Dean.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
          <li class="p-2 border bg-gray-50 rounded-3xl">
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/arieff.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
          <li class="p-2 border bg-gray-50 rounded-3xl">
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/rafi.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
          <li class="p-2 border bg-gray-50 rounded-3xl">
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/hokky.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
          <li class="p-2 border bg-gray-50 rounded-3xl">
            <figure class="relative flex flex-col justify-between h-full p-6 bg-white border shadow-lg rounded-2xl">
              ...
              <figcaption class="relative flex items-center justify-between pt-6 mt-6">
                ...
                <div class="overflow-hidden rounded-full bg-gray-50">
                  <img alt="" src="<?php echo e(asset('img/mawar.jpg')); ?>" width="56" height="56" decoding="async" data-nimg="future" class="object-cover h-14 w-14 grayscale" loading="lazy" style="color: transparent">
                </div>
              </figcaption>
            </figure>
          </li>
                    ...
                    <div class="grid gap-12 lg:grid-cols-3">
                        ...
                        <ul role="list" class="flex flex-col gap-12">
                            ...
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/dandy.png')); ?>" alt="">
                                <div class="space-y-1">
                            ...
                            <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/abi.png')); ?>" alt="">
                                <div class="space-y-1">
                                <h3 class="text-lg font-medium leading-6 text-black">
                                    Abiyoga Dhaniswara
                                </h3>
                        ...
                        <ul role="list" class="flex flex-col gap-12">
                            <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/pandu.png')); ?>" alt="">
                                <div class="space-y-1">
                                <h3 class="text-lg font-medium leading-6 text-black">
                                    Pandu Daniel
                                </h3>
                            ...
                            <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/subhil.png')); ?>" alt="">
                                <div class="space-y-1">
                                <h3 class="text-lg font-medium leading-6 text-black">
                        ...
                        <ul role="list" class="flex flex-col gap-12">
                            <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/tasya.png')); ?>" alt="">
                                <div class="space-y-1">
                                <h3 class="text-lg font-medium leading-6 text-black">
                                    Tasya Ramdhani
                                </h3>
                            ...
                            <li>
                            <div class="flex items-center space-x-4 lg:space-x-6">
                                <img class="object-cover w-16 h-16 rounded-full lg:h-20 lg:w-20" src="<?php echo e(asset('img/zulfa.png')); ?>" alt="">
                                <div class="space-y-1">
                                <h3 class="text-lg font-medium leading-6 text-black">
                                    Zulfa Ikhsanudin
                                </h3>

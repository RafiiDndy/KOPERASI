            ...
            <nav class="flex-1 space-y-1 bg-side-nav ">
                ...
                <li>
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                        <ul>
                        <li>
                            <a href="<?php echo e(route('Topic.index')); ?> " :active="request()->routeIs('Topic.index')" title="#" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-white-500 rounded-lg hover:text-blue-500 group hover:bg-gray-50">
                ...
                <li>
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                        <ul>
                        <li>
                            <a href="<?php echo e(route('Anggota.index')); ?> " :active="request()->routeIs('Anggota.index')" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-white-500 rounded-lg hover:text-blue-500 group hover:bg-gray-50">
                            <span class="inline-flex items-center w-full">
                                <ion-icon class="size-4 md hydrated" name="people-outline" role="img" aria-label="flower outline"></ion-icon>
                        ...
                        <li>
                            <a href="<?php echo e(route('Simpanan.manage')); ?>" :active="request()->routeIs('Simpanan.manage')" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-white-500 rounded-lg hover:text-blue-500 group hover:bg-gray-50">
                            <span class="inline-flex items-center w-full">
                ...
                <li>
                    <a href="<?php echo e(route('Anggota.expense')); ?>" :active="request()->routeIs('Anggota.expense')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-white-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500">

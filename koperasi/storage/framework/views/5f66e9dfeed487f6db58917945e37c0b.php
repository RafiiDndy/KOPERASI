<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-white shadow-md rounded px-8 py-6">
        <!--[if BLOCK]><![endif]--><?php if(Auth::user()->status_anggota == 'Not_verified'): ?>
        <div class='mb-8'>
...
<?php /**PATH D:\PROJECT RPL\Koperasi Main\koperasi\resources\views/livewire/simpanan/add.blade.php ENDPATH**/ ?>
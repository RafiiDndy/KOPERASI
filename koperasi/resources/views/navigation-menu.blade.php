    ...
    <div class="hidden md:flex md:flex-shrink-0">
        ...
        <div class="flex flex-col flex-grow pt-5 overflow-y-auto bg-side-nav">
            ...
            <nav class="flex-1 space-y-1 bg-side-nav ">
                ...
                <ul>
                <li>
                    <a href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-white-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500">
                ...
                <li>
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                        <ul>
                        <li>
                            <a href="{{ route('Topic.index') }} " :active="request()->routeIs('Topic.index')" title="#" class="inline-flex items-center w-full p-2 pl-3 text-sm font-light text-white-500 rounded-lg hover:text-blue-500 group hover:bg-gray-50">
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                        ...
                        <li>
                            ...
                            <span class="inline-flex items-center w-full">
                                ...
                                <span class="ml-4"> Simpanan </span>
                                <span class="inline-flex ml-auto items-center rounded-full bg-blue-50 px-2.5 py-0.5 text-xs font-medium text-blue-500">
                                {{ @App\Models\CatatanSimpanan::query()->where('status','menunggu verifikasi')->count() }}
                                </span>
                            </span>
                            </a>
                        </li>
                ...
                <li>
                    <a href="{{ route('Recapitulation.index') }}" :active="request()->routeIs('Recapitulation.index')" class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-white-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500">
            ...
            <div @click.away="open = false" class="relative inline-flex items-center w-full " x-data="{ open: false }">
                ...
                <span>
                    ...
                    <div class="flex items-center ">
                        <div>
                        <img class="inline-block object-cover rounded-full h-9 w-9" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}">
                        </div>
                ...
                <div class="px-2 py-2 bg-gray rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <ul>
                    <li>
                        <a href="{{ route('profile.show') }}" class="inline-flex items-center w-full px-4 py-2 mt-1 text-sm text-gray-500 transition duration-200 ease-in-out transform rounded-lg focus:shadow-outline hover:bg-gray-100 hover:scale-95 hover:text-blue-500" href="#_">

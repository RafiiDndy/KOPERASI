...
<body class="bg-green-500 text-white font-sans">
        ...
        <div class="container mx-auto flex items-center justify-between">
            ...
            <div>
                @if (Route::has('login'))
                    ...
                    @else
                        <a href="{{ route('login') }}" class="inline-block px-4 py-2 text-white rounded bg-black hover:bg-blue-500 hover:text-gray-200">Login</a>
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="inline-block px-4 py-2 text-white bg-black p-3 rounded shadow hover:bg-red-500">Register</a>
                            @endif
                        @endauth
                    </div>
                @endif
    ...
    <div class="relative z-10">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-lg">Sebuah aplikasi yang dapat membantu manajemen dan operasi koperasi serta memfasilitasi berbagai aspek kegiatan koperasi, seperti manajemen anggota, pengelolaan simpanan, pelacakan transaksi, dan lain sebagainya. </p>
        </div>

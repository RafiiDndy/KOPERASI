<div class="form-container-activity">
    <h2 class="text-2xl font-bold text-center">Expense Activity</h2>
    <form class="form-activity">
        ...
        <button class="form-submit-btn-activity" type="button" wire:click.prevent="pengeluaran">Pengeluaran</button>
    </form>
</div>
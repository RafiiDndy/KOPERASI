            ...
            <div class="w-full mx-auto mr-44 md:px-0 sm:px-4">
                ...
                <form enctype="multipart/form-data" class="form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="space-y-3 mt-8">
                        ...
                        @endif
                        <div class="col-span-full">
                            <button dusk="signup" type="submit" class="inline-flex items-center justify-center w-full h-12 gap-3 px-5 py-3 font-medium text-white duration-200 bg-gray-900 rounded-xl hover:bg-gray-700 focus:ring-2 focus:ring-offset-2 focus:ring-black">
                                Sign up
                            </button>
                        </div>
                    </div>
